/* Electrical Career Readiness Hub — Evidence Engine v1.4.
 ...
 * Recapture lineage is derived from the prior persisted Evidence record when available.
 */
...
export function normalize(module, input) {
  ...
  const priorEvidence = context.previousEvidence || context.priorEvidence || null;
